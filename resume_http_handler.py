...
""" Resume HTTP Server With Upload.
This module builds on http.server by implementing the standard GET and HEAD requests in a fairly straightforward manner.
"""
__version__ = "0.1"
__all__ = ["ResumeHTTPHandler"]
__author__ = "Ellick Lu, Quantum HR"
...
def test(HandlerClass = ResumeHTTPHandler,
		 ServerClass = http.server.HTTPServer):
	http.server.test(HandlerClass, ServerClass, "HTTP/1.1", 8080)
